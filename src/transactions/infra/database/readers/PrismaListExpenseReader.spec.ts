...
describe('PrismaListExpenseReader', () => {
  let findMany: jest.Mock;
  let query: PrismaListExpenseReader;
  ...
  beforeEach(() => {
    ...
    query = new PrismaListExpenseReader(prisma);
  });
  ...
  it('should return PRISMA_QUERY_ERROR when findMany throws', async () => {
    ...
    expect(result.errors[0].cls).toBe('PrismaListExpenseReader');
  });
});
