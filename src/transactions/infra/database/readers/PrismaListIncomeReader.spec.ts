...
describe('PrismaListIncomeReader', () => {
  let findMany: jest.Mock;
  let query: PrismaListIncomeReader;
  ...
  beforeEach(() => {
    ...
    query = new PrismaListIncomeReader(prisma);
  });
  ...
  it('should return PRISMA_QUERY_ERROR when findMany throws', async () => {
    ...
    expect(result.errors[0].cls).toBe('PrismaListIncomeReader');
  });
});
