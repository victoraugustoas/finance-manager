...
describe('PrismaTransactionCategoryHierarchyAcl', () => {
  ...
  let acl: PrismaTransactionCategoryHierarchyAcl;
  ...
  beforeEach(() => {
    ...
    acl = new PrismaTransactionCategoryHierarchyAcl(prisma);
  });
  ...
  describe('ensureIncomeHierarchy()', () => {
    ...
    it('should return REFERENCE_CATEGORY_NOT_FOUND when category does not exist', async () => {
      ...
      expect(result.errors[0].cls).toBe('PrismaTransactionCategoryHierarchyAcl');
