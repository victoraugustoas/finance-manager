...
import { EditTransactionHandler } from './EditTransaction.handler';
...
describe('EditTransactionHandler', () => {
  ...
  let accounts: TransactionAccountReader;
  let categoryHierarchy: TransactionCategoryHierarchyReader;
  ...
  describe('INCOME', () => {
    it('should fail when income is not found without calling persistence', async () => {
      ...
      const useCase = new EditTransactionHandler(
        transactionsRepository,
        accounts,
        categoryHierarchy,
      );

      const result = await useCase.handle(baseIncomeParams);
    ...
    it('should fail when income entity edit fails without persisting', async () => {
      ...
      const result = await useCase.handle({ ...baseIncomeParams, amount: 0 });
    ...
    it('should call ensureIncomeHierarchy with the correct category ids', async () => {
      ...
      await useCase.handle(baseIncomeParams);
  ...
  describe('EXPENSE', () => {
    it('should fail when expense is not found without calling persistence', async () => {
      ...
      const result = await useCase.handle(baseExpenseParams);
    ...
    it('should fail when expense entity edit fails without persisting', async () => {
      ...
      const result = await useCase.handle({ ...baseExpenseParams, amount: 0 });
    ...
    it('should call ensureExpenseHierarchy with the correct category ids', async () => {
      ...
      await useCase.handle(baseExpenseParams);
